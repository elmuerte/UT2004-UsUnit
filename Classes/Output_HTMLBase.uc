/*******************************************************************************
    ...
    <!-- $Id: Output_HTMLBase.uc,v 1.1 2005/09/08 10:40:23 elmuerte Exp $ -->
*******************************************************************************/
...
function _head()
{
    ...
    Logf("    <meta name=\"generator\"/ content=\"$Id: Output_HTMLBase.uc,v 1.1 2005/09/08 10:40:23 elmuerte Exp $\">");
    _style();
    Logf("</head>");
    Logf("<body>");
