...
<p>
    ...
    <!-- $Id: Output_HTMLBase.uc,v 1.3 2005/09/23 09:23:41 elmuerte Exp $ -->
*******************************************************************************/
...
function _head()
{
    ...
    Logf("    <meta name=\"generator\"/ content=\"$Id: Output_HTMLBase.uc,v 1.3 2005/09/23 09:23:41 elmuerte Exp $\">");
    _style();
    Logf("</head>");
    Logf("<body>");
