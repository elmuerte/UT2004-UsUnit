...
/*******************************************************************************
    ...
    <!-- $Id: UsUnitUtils.uc,v 1.1 2005/07/28 16:06:11 elmuerte Exp $ -->
*******************************************************************************/
...
// #ifdef UE25
    ...
    if (package == "") return -1;
    if (!PackageExists(package)) return -1;
...
*/
function bool PackageExists(string package)
{
